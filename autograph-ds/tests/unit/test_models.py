...
def mock_data_path(temp_dir):
    ...
    data = {
        ...
        "feature1": [1.0 + np.random.normal(0, 0.01) for _ in range(10)]
        + [5.0 + np.random.normal(0, 0.01) for _ in range(10)],
        "feature2": [0.1 + np.random.normal(0, 0.01) for _ in range(10)]
        + [0.9 + np.random.normal(0, 0.01) for _ in range(10)],
    }
