...
def run_demo():
    ...
    with open(base / "research/data/raw/ai_gpt4o.py", "r") as f:
        gpt_code = f.read()
    ...
    with open(base / "research/data/raw/ai_deepseek_v3.py", "r") as f:
    ...
    with open(base / "research/data/raw/human_requests.py", "r") as f:
        req_code = f.read()
