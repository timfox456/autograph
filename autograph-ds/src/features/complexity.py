...
class CyclomaticComplexityExtractor:
    ...
    def _analyze_branching_patterns(self, code: str, root_node: Node) -> Dict[str, Any]:
        ...
        features['average_if_depth'] = sum(nested_if_depths) / len(nested_if_depths) if nested_if_depths else 0
        ...
        features['ternary_to_branch_ratio'] = ternary_count / total_branches if total_branches > 0 else 0
    ...
    def _analyze_exception_complexity(self, code: str, root_node: Node) -> Dict[str, Any]:
        ...
        features['specific_exception_ratio'] = total_specific / except_count if except_count > 0 else 0
